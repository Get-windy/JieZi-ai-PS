...
import type { OpenClawConfig, SlackReactionNotificationMode } from "../../../upstream/src/config/config.js";
import { resolveSessionKey, type SessionScope } from "../../../upstream/src/config/sessions.js";
import type { DmPolicy, GroupPolicy } from "../../../upstream/src/config/types.js";
import { logVerbose } from "../../../upstream/src/globals.js";
import { createDedupeCache } from "../../../upstream/src/infra/dedupe.js";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("../../../upstream/src/config/config.js").SlackSlashCommandConfig>;
  textLimit: number;
