...
export type AuthConfig = {
  ...
  cooldowns?: {
    ...
    /**
     * Fixed delay (ms) before retrying a rate-limited provider/profile rotation.
     * Mirrors overloadedBackoffMs but applies to 429 rate-limit errors.
     * Default: 0. Recommended: 3000–10000 when ali-bailian RPM is exhausted.
     */
    rateLimitedBackoffMs?: number;
  };
};
