...
vi.mock("../../../upstream/extensions/discord/src/monitor/thread-bindings.js", async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import("../../../upstream/extensions/discord/src/monitor/thread-bindings.js")
    >();
  return {
    ...actual,
...
vi.mock("../../../upstream/extensions/telegram/src/thread-bindings.js", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../../../upstream/extensions/telegram/src/thread-bindings.js")>();
  return {
    ...actual,
