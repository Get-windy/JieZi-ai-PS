...
export function buildProjectContext(
  ...
  const requirementsDir = config?.requirementsDir || path.join(workspacePath, 'requirements');
 ...
 */
export function projectWorkspaceExists(
  projectId: string,
  workspaceRoot?: string
): boolean {
  try {
 ...
 */
export function readProjectSharedMemory(
  projectId: string,
  workspaceRoot?: string
): string | null {
  try {
 ...
 * ```
 */
export function generateProjectSwitchInstructions(
  projectId: string,
  currentDir?: string
): string {
