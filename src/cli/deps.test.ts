...
vi.mock("../../upstream/extensions/telegram/src/send.js", () => {
  moduleLoads.telegram();
  return { sendMessageTelegram: sendFns.telegram };
});

vi.mock("../../upstream/extensions/discord/src/send.js", () => {
  moduleLoads.discord();
  return { sendMessageDiscord: sendFns.discord };
});

vi.mock("../../upstream/extensions/slack/src/send.js", () => {
  moduleLoads.slack();
  return { sendMessageSlack: sendFns.slack };
});

vi.mock("../../upstream/extensions/signal/src/send.js", () => {
  moduleLoads.signal();
  return { sendMessageSignal: sendFns.signal };
});

vi.mock("../../upstream/extensions/imessage/src/send.js", () => {
