...
export function createDefaultDeps(): CliDeps {
  return {
    ...
    telegram: createLazySender(
      "telegram",
      () => import("../../upstream/extensions/telegram/src/send.js") as Promise<Record<string, unknown>>,
      "sendMessageTelegram",
    ),
    ...
    imessage: createLazySender(
      "imessage",
      () => import("../../upstream/extensions/imessage/src/send.js") as Promise<Record<string, unknown>>,
      "sendMessageIMessage",
    ),
  };
}
...
export { logWebSelfId } from "../../upstream/extensions/whatsapp/src/auth-store.js";
