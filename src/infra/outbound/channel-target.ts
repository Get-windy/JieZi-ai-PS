...
export const CHANNEL_TARGET_DESCRIPTION =
  "Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack channel/user, iMessage handle/chat_id, or Feishu user:ou_xxx/group:oc_xxx (NEVER use display names/nicknames for Feishu — always use the openId/chatId)";
