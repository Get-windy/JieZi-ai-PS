...
export const pt_BR: TranslationMap = {
  ...
  usage: {
    ...
    tipFilters: "Dica: use filtros ou clique em barras para filtrar dias.",
    agent: "Agente",
    channel: "Canal",
    provider: "Provedor",
    model: "Modelo",
    ...
    noSessionsInRange: "0 sessões no intervalo",
    noTimelineData: "Nenhum dado de linha do tempo ainda.",
    noData: "Sem dados",
    shown: "exibido",
    avg: "média",
    errors: "erros",
