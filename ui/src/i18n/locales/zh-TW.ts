...
export const zh_TW: TranslationMap = {
  ...
  usage: {
    ...
    costBtn: "成本",
    refresh: "刷新",
    filterSessions: "篩選會話 (例如: key:agent:main:cron* model:gpt-4o has:errors minTokens:2000)",
    filterClientSide: "篩選（客戶端）",
    clear: "清除",
    sessionsMatch: "匹配 {filtered}/{total} 個會話",
    sessionsInRange: "範圍內 {total} 個會話",
    tipFilters: "提示：使用篩選器或點擊柱狀圖來篩選日期。",
    agent: "代理",
    channel: "頻道",
    provider: "供應商",
    model: "模型",
