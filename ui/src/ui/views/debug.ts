            ...
            ${
              securitySummary
                ? html`<div class="callout ${securityTone}" style="margin-top: 8px;">
                  ${t("debug.security.audit").replace("{label}", securityLabel).replace("{command}", "openclaw security audit --deep")}${info > 0 ? ` · ${t("debug.security.info").replace("{count}", String(info))}` : ""}.
                </div>`
                : nothing
            }
        ...
        <div class="form-grid" style="margin-top: 16px;">
          <label class="field">
            ...
            <input
              ...
              placeholder="${t("debug.rpc.method.placeholder")}"
            />
          </label>
          <label class="field">
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      ${
        props.eventLog.length === 0
          ? html`
              <div class="muted" style="margin-top: 12px">${t("debug.events.no_events")}</div>
            `
          : html`
