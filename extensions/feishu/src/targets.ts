...
// Some Feishu group IDs use the "group_" prefix (internal channel/group IDs).
...
export function detectIdType(id: string): FeishuIdType | null {
  ...
  if (trimmed.startsWith(GROUP_ID_PREFIX)) {
    return "chat_id";
  }
...
export function resolveReceiveIdType(id: string): "chat_id" | "open_id" | "user_id" {
  ...
  // Feishu internal group IDs (e.g. group_xxxx) should be treated as chat_id.
  if (trimmed.startsWith(GROUP_ID_PREFIX)) {
    return "chat_id";
  }
  return "user_id";
